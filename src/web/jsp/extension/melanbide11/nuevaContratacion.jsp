...
///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function CB_clearSelected() {
        ...
        <script type="text/javascript">
            ...
            function safeReplaceQuotes(txt) { return (txt || "").replace(/\'/g, "''"); }
            ...
            function buscaCodigoTitReqPuesto(cod) { if (comboListaTitReqPuesto) comboListaTitReqPuesto.buscaCodigo(cod); }
            function cargarDatosTitReqPuesto() { var cod = v('codListaTitReqPuesto'); buscaCodigoTitReqPuesto(cod); }
            ...
            function guardarDatos() {
                if (validarDatosNumericosVacios() && validarDatos()) {
                    ...
                    var nodos = null; var url = APP_CONTEXT_PATH + "/PeticionModuloIntegracion.do"; var parametros = "";
                    var nuevo = "<%=nuevo%>";
                    ...
                    if (nuevo != null && nuevo == "1") {
                                    parametros = "tarea=preparar&modulo=MELANBIDE11&operacion=crearNuevaContratacion&tipo=0"
                                        ...
                                        + "&oferta=" + v('oferta')
                                        + "&idContrato1=" + v('idContrato1')
                                        + "&idContrato2=" + v('idContrato2')
                                        + "&dni=" + encodeURIComponent(v('dni'))
                            ...
                            + "&edad=" + v('edad')
                            + "&sexo=" + v('codListaSexo')
                            + "&mayor55=" + v('codListaMayor55')
                            + "&finFormativa=" + v('codListaFinFormativa')
                            + "&codFormativa=" + v('codFormativa')
                            + "&denFormativa=" + encodeURIComponent(v('denFormativa'))
                            ...
                            + "&modalidadContrato=" + v('modalidadContrato')
                            + "&jornada=" + v('codListaJornada')
                            + "&porcJornada=" + v('porcJornada')
                            + "&horasConv=" + v('horasConv')
                            + "&fechaInicio=" + v('fechaInicio')
                            + "&fechaFin=" + v('fechaFin')
                            + "&mesesContrato=" + v('mesesContrato')
                            + "&grupoCotizacion=" + v('codListaGrupoCotizacion')
                            + "&direccionCT=" + encodeURIComponent(v('direccionCT'))
                            + "&numSS=" + v('numSS')
                            + "&costeContrato=" + v('costeContrato')
                            + "&tipRetribucion=" + v('codListaTipRetribucion')
                            + "&importeSub=" + v('importeSub')
                            // === NUEVOS CAMPOS ===
                    ...
                    try {
                        ...
                        if (ajax.readyState == 4 && ajax.status == 200) {
                            ...
                            var fila = new Array(); var nodoFila; var hijosFila;
                            for (j = 0; hijos != null && j < hijos.length; j++) {
                                if (hijos[j].nodeName == "CODIGO_OPERACION") { codigoOperacion = hijos[j].childNodes[0].nodeValue; lista[j] = codigoOperacion; }
                                else if (hijos[j].nodeName == "FILA") {
                                    nodoFila = hijos[j]; hijosFila = nodoFila.childNodes;
                                    for (var cont = 0; cont < hijosFila.length; cont++) {
                                        if (hijosFila[cont].nodeName == "ID") { fila[0] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "NOFECONT") { fila[1] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "IDCONT1") { fila[2] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "IDCONT2") { fila[3] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "DNICONT") { fila[4] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "NOMCONT") { fila[5] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "APE1CONT") { fila[6] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "APE2CONT") { fila[7] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "FECHNACCONT") { fila[8] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "EDADCONT") { fila[9] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "SEXOCONT") { fila[10] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "MAY55CONT") { fila[11] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "ACCFORCONT") { fila[12] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "CODFORCONT") { fila[13] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "DENFORCONT") { fila[14] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "PUESTOCONT") { fila[15] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "CODOCUCONT") { fila[16] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "OCUCONT") { fila[17] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "DESTITULACION") { fila[18] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "TITULACION") { fila[19] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "CPROFESIONALIDAD") { fila[20] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "MODCONT") { fila[21] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "JORCONT") { fila[22] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "PORCJOR") { if (hijosFila[cont].childNodes[0].nodeValue != "null") { fila[23] = hijosFila[cont].childNodes[0].nodeValue.toString().replace('.', ','); } else { fila[23] = '-'; } }
                                        else if (hijosFila[cont].nodeName == "HORASCONV") { fila[24] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "FECHINICONT") { fila[25] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "FECHFINCONT") { fila[26] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "DURCONT") { fila[27] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "GRSS") { fila[28] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "DIRCENTRCONT") { fila[29] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "NSSCONT") { fila[30] = (hijosFila[cont].childNodes.length > 0) ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "CSTCONT") { if (hijosFila[cont].childNodes[0].nodeValue != "null") { fila[31] = hijosFila[cont].childNodes[0].nodeValue.toString().replace('.', ','); } else { fila[31] = '-'; } }
                                        else if (hijosFila[cont].nodeName == "TIPRSB") { fila[32] = (hijosFila[cont].childNodes[0].nodeValue != "null") ? hijosFila[cont].childNodes[0].nodeValue : '-'; }
                                        else if (hijosFila[cont].nodeName == "IMPSUBVCONT") { if (hijosFila[cont].childNodes[0].nodeValue != "null") { fila[33] = hijosFila[cont].childNodes[0].nodeValue.toString().replace('.', ','); } else { fila[33] = '-'; } }
                                    }
                                    lista[j] = fila; fila = new Array();
                                }
                            }
                        } else {
                        ...
                        else if (codigoOperacion == "1") { jsp_alerta("A", '<%=meLanbide11I18n.getMensaje(idiomaUsuario,"error.errorBD")%>'); }
                        else if (codigoOperacion == "2") { jsp_alerta("A", '<%=meLanbide11I18n.getMensaje(idiomaUsuario,"error.errorGen")%>'); }
                        else if (codigoOperacion == "3") { jsp_alerta("A", '<%=meLanbide11I18n.getMensaje(idiomaUsuario,"error.pasoParametros")%>'); }
                        else { jsp_alerta("A", '<%=meLanbide11I18n.getMensaje(idiomaUsuario,"error.errorGen")%>'); }
                    } catch (Err) { }
                } else {
    ...
    if (funcionesEl && funcionesEl.value && funcionesEl.value.length > 200) {
        mensajeValidacion = '<%=meLanbide11I18n.getMensaje(idiomaUsuario, "msg.errExcdTexto")%>';
        return false;
    }
    ...
    if (elTitReq1) { titReqPuesto = elTitReq1.value; }
        ...
        var elTitReq2 = document.getElementById('titReqPuesto');
        if (elTitReq2) { titReqPuesto = elTitReq2.value; }
    }
