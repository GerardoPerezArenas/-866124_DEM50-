...
// Reemplazar document.write() por método moderno para evitar warnings de rendimiento
(function() {
    var css = [
        ...
        'div.ff-fill { height: 23px; width: 23px; border-right: 1px solid #FFF; border-bottom: 1px solid #FFF; }',
        'tr.horizontal-scroll { line-height: 22px; }'
    ].join('\n');
    ...
    // Insertar en el head cuando el DOM esté listo
    if (document.head) {
        document.head.appendChild(style);
    } else {
        // Fallback: insertar cuando el documento cargue
